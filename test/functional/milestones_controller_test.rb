...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { by_whom: @milestone.by_whom, deliverable: @milestone.deliverable, description: @milestone.description, extern_link: @milestone.extern_link, finished_by: @milestone.finished_by }
    end
  ...
  test "should update milestone" do
    put :update, id: @milestone, milestone: { by_whom: @milestone.by_whom, deliverable: @milestone.deliverable, description: @milestone.description, extern_link: @milestone.extern_link, finished_by: @milestone.finished_by }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
